...
![Node-RED Dashboard Layout Slide 9](NRD-Layout-MoveWidget.png?raw=true "Node-RED Dashboard Chart")
![Node-RED Dashboard Layout Slide 10](NRD-Layout-Resize.png?raw=true "Node-RED Dashboard Chart")
![Node-RED Dashboard Layout Slide 11](NRD-Layout-Theme.png?raw=true "Node-RED Dashboard Chart")
